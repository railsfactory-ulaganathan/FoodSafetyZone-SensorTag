//
//  CSAddEquipmentsViewController.m
//  FoodSafetyZone
//
...
#import "CSAddEquipmentsViewController.h"
#define SOURCETYPE UIImagePickerControllerSourceTypeCamera

@interface CSAddEquipmentsViewController ()
{
    UIImage *selectedImage;
}
@end

@implementation CSAddEquipmentsViewController
...
-(void)doneClicked
{
    ...
    else
    {
        ...
        status = [dbManager.fmDatabase  executeUpdate:@"INSERT INTO cleaningEquipments(id,equipmentName,equipmentImage) VALUES(NULL,?,?)",equipmentNameField.text,imgData,nil];
        imgData = nil;
        if (status == YES)
        {
