//
//  MasterEquipmentsViewController.h
//  FoodSafetyZone
//
//  Created by railsfactory on 31/10/13.
...
@interface MasterEquipmentsViewController : UIViewController<UISearchBarDelegate,UIAlertViewDelegate>
{
